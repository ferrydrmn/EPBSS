...
<?php 
    $query = "SELECT * FROM informasi_properti WHERE acceptable = 'Iya' ORDER BY id_properti DESC";
...
<body>
    ...
    <div class="banner">
        ...
        <h1 class="quote">Eproperty - Property Buying & Selling Site</h1>
    </div>
    <?php
        if(mysqli_num_rows($result) > 0){
            ...
            echo "<div style='margin: 50px 0; font-size: 36px;'>Belum ada informasi properti yang bisa ditampilkan.</div>";
        }
    ?>
    </main>
